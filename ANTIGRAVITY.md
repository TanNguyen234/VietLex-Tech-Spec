...
5. **Documentation Map**: Use [`docs/DOCUMENTATION_INDEX.md`](docs/DOCUMENTATION_INDEX.md) to distinguish current sources from dated plans and reports.

## Non-Negotiable Operational Principles

- **No Implicit Destructive Vector Operations**: Delete, recreate, migrate, or
  reingest operations require explicit authority for the exact remote target;
  ordinary code/evaluation work does not grant it.
