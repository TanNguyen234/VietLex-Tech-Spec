...
| Báo cáo editable / version / export | Có preview Markdown an toàn, citation về snapshot, editor, lưu bản mới, MD/DOCX, in/lưu PDF qua browser | `tests/test_report_deliverables.py`, `tests/test_research_report_routes.py` | Production 12/09 MD/DOCX; Chrome local 12/09 mở DOCX/in PDF/kiểm tra nội dung | DOCX cơ bản, URL dạng text; PDF không có renderer server; 50 analysis gần nhất; bản sửa luôn unverified; chưa mọi citation link tới đúng khoản |
