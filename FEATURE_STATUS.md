...
Cập nhật ngày 2026-09-12; runtime e977ddb bổ sung tìm/đọc căn cứ ngoài corpus và sửa UX. Đây là nguồn trạng thái chức năng hiện tại; tài liệu review có ngày là lịch sử. [Nghiệm thu thực chạy](docs/evaluation/runs/official-online-20260912T140633Z/REPORT.md) phân biệt local API với production smoke. Primary workflow: người nghiên cứu pháp lý/compliance tìm văn bản → tổ chức căn cứ → rà soát tài liệu → xử lý findings → xuất báo cáo.
