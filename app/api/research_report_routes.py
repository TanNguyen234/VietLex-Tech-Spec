...
from app.services.report_deliverables import report_body, report_sources, report_markdown, report_docx, report_preview, report_review_notice
...
async def report_editor(request: Request, workspace_id: str, analysis_id: str, current_user=Depends(optional_user)):
    ...
    return _workspace_page(request, "report_editor.html", {"workspace_id": workspace_id, "analysis": analysis,
        "body": report_body(analysis), "preview": report_preview(analysis), "sources": report_sources(analysis),
        "review_notice": report_review_notice(analysis), "workspace_user": current_user})
