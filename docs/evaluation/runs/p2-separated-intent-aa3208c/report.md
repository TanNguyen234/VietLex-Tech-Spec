# VIETLEX EVALUATION REPORT — p2-separated-intent-aa3208c

**Run ID**: `p2-separated-intent-aa3208c`  
**Profile**: `separated_intent`  
**UTC Timestamp**: `2026-08-09T15:43:38.379402+00:00`  
...
**Configuration Fingerprint**: `cbdce11726a58226740c17451510a43ac6c22b6acb9c16298565e41881a7df2d`  
...
| :--- | ---: | ---: | ---: |
| `t_retrieval` | 4.1044 | 15.5087 | 6.4888 |
| `t_rewrite` | 0.0000 | 0.0000 | 0.0000 |
| `t_total` | 4.1044 | 15.5088 | 6.4889 |
