# VIETLEX EVALUATION REPORT — retrieval-v3-raw-verified40-20260827-final2

**Run ID**: `retrieval-v3-raw-verified40-20260827-final2`  
**Profile**: `separated_intent`  
**UTC Timestamp**: `2026-08-27T10:55:40.824038+00:00`  
...
**Execution Command**: `run_retrieval_eval.py --verified-only --backend vertex-qdrant-v3 --ranking raw-rrf --profile separated_intent --rewrite off --reranker current --concurrency 1 --run-id retrieval-v3-raw-verified40-20260827-final2`  
...
| :--- | ---: | ---: | :---: | :---: | :--- |
| Document Recall @ 1 | 0.9250 | 0.9057 | 48.0000/53.0000 | 40 / 0 | none |
...
| Article Recall @ 1 | 0.7778 | 0.7667 | 23.0000/30.0000 | 27 / 13 | no_applicable_gold=13 |
...
| Article MRR | 0.9074 | 0.9074 | 24.5000/27.0000 | 27 / 13 | no_applicable_gold=13 |
| Clause MRR | 0.7949 | 0.7949 | 10.3333/13.0000 | 13 / 27 | no_applicable_gold=27 |
| Document MRR | 0.9625 | 0.9625 | 38.5000/40.0000 | 40 / 0 | none |
| nDCG @ 10 | 0.9126 | 0.8931 | 43.0474/48.2021 | 40 / 0 | none |
...
| :--- | ---: | ---: | ---: |
| `t_retrieval` | 2.9032 | 4.5580 | 3.4684 |
| `t_rewrite` | 0.0000 | 0.0000 | 0.0000 |
| `t_total` | 2.9033 | 4.5580 | 3.4685 |
...
| :--- | :--- | :--- | :---: | :--- | ---: |
| `case_017` | `ok` | `N/A` | `no` | `none` | 25.1397 |
| `case_019` | `ok` | `N/A` | `no` | `none` | 1.8720 |
| `case_021` | `ok` | `N/A` | `no` | `none` | 1.3185 |
| `case_031` | `ok` | `N/A` | `no` | `none` | 2.0244 |
| `case_036` | `ok` | `N/A` | `no` | `none` | 2.4403 |
| `case_039` | `ok` | `N/A` | `no` | `none` | 3.4205 |
| `case_043` | `ok` | `N/A` | `no` | `none` | 1.3162 |
| `case_061` | `ok` | `N/A` | `no` | `none` | 2.2633 |
| `case_065` | `ok` | `N/A` | `no` | `none` | 3.4233 |
| `case_075` | `ok` | `N/A` | `no` | `none` | 2.0734 |
| `case_101` | `ok` | `N/A` | `no` | `none` | 2.4169 |
| `case_121` | `ok` | `N/A` | `no` | `none` | 3.2423 |
| `case_127` | `ok` | `N/A` | `no` | `none` | 4.5244 |
| `case_133` | `ok` | `N/A` | `no` | `none` | 2.7532 |
| `case_135` | `ok` | `N/A` | `no` | `none` | 3.6054 |
| `case_165` | `ok` | `N/A` | `no` | `none` | 1.5742 |
| `case_171` | `ok` | `N/A` | `no` | `none` | 2.1320 |
| `case_177` | `ok` | `N/A` | `no` | `none` | 2.5875 |
| `case_187` | `ok` | `N/A` | `no` | `none` | 4.0926 |
| `case_204` | `ok` | `N/A` | `no` | `none` | 3.0661 |
| `case_227` | `ok` | `N/A` | `no` | `none` | 3.8864 |
| `case_243` | `ok` | `N/A` | `no` | `none` | 3.2624 |
| `case_253` | `ok` | `N/A` | `no` | `none` | 2.8834 |
| `case_257` | `ok` | `N/A` | `no` | `none` | 2.4234 |
| `case_261` | `ok` | `N/A` | `no` | `none` | 2.6391 |
| `case_263` | `ok` | `N/A` | `no` | `none` | 3.0193 |
| `case_285` | `ok` | `N/A` | `no` | `none` | 3.1354 |
| `case_309` | `ok` | `N/A` | `no` | `none` | 5.1967 |
| `case_323` | `ok` | `N/A` | `no` | `none` | 2.6554 |
| `case_329` | `ok` | `N/A` | `no` | `none` | 3.9858 |
| `case_331` | `ok` | `N/A` | `no` | `none` | 2.6674 |
| `case_339` | `ok` | `N/A` | `no` | `none` | 2.8229 |
| `case_355` | `ok` | `N/A` | `no` | `none` | 2.2222 |
| `case_361` | `ok` | `N/A` | `no` | `none` | 3.7244 |
| `case_371` | `ok` | `N/A` | `no` | `none` | 3.5249 |
| `case_374` | `ok` | `N/A` | `no` | `none` | 2.9232 |
| `case_375` | `ok` | `N/A` | `no` | `none` | 3.7219 |
| `case_379` | `ok` | `N/A` | `no` | `none` | 3.0117 |
| `case_397` | `ok` | `N/A` | `no` | `none` | 3.2442 |
| `case_411` | `ok` | `N/A` | `no` | `none` | 2.5022 |