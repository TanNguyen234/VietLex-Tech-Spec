# VIETLEX EVALUATION REPORT — retrieval-crosslane-a-rep10-20260823

**Run ID**: `retrieval-crosslane-a-rep10-20260823`  
**Profile**: `separated_intent`  
**UTC Timestamp**: `2026-08-23T13:21:25.903472+00:00`  
...
**Configuration Fingerprint**: `1635926badd2f40127d82bac14c6a185ff9339181dd039a9c64dd71137997936`  
**Execution Command**: `run_retrieval_eval.py --case-ids case_017 case_036 case_061 case_101 case_165 case_243 case_261 case_323 case_329 case_397 --verified-only --gold-policy all-required-verified --profile separated_intent --rewrite off --reranker current --concurrency 1 --require-clean-git --run-id retrieval-crosslane-a-rep10-20260823`  
...
| Article Recall @ 3 | 0.8571 | 0.7500 | 6.0000/8.0000 | 7 / 3 | no_applicable_gold=3 |
...
| Clause Recall @ 3 | 0.7500 | 0.6000 | 3.0000/5.0000 | 4 / 6 | no_applicable_gold=6 |
...
| Clause MRR | 0.7500 | 0.7500 | 3.0000/4.0000 | 4 / 6 | no_applicable_gold=6 |
| Document MRR | 0.6667 | 0.6667 | 6.6667/10.0000 | 10 / 0 | none |
| nDCG @ 10 | 0.7839 | 0.7186 | 9.0000/12.5237 | 10 / 0 | none |
| Exact legal-reference hit | 0.9000 | 0.9000 | 9.0000/10.0000 | 10 / 0 | none |
| Multi-hop all-required coverage | 0.9000 | 0.9000 | 9.0000/10.0000 | 10 / 0 | none |
| Multi-hop partial coverage | 0.9000 | 0.8571 | 12.0000/14.0000 | 10 / 0 | none |
...
| `final_evidence_metrics` | 5 | 10 | 3.0000 / 3.0000 | 12 / 14 | 2 | k_exceeds_configured_capacity=40, no_applicable_gold=27 |
...
| :--- | ---: | ---: | ---: |
| `t_retrieval` | 5.1155 | 16.6845 | 7.0354 |
| `t_rewrite` | 0.0000 | 0.0000 | 0.0000 |
| `t_total` | 5.1155 | 16.6846 | 7.0355 |
...
| :--- | :--- | :--- | :---: | :--- | ---: |
| `case_017` | `ok` | `N/A` | `no` | `none` | 23.8439 |
| `case_036` | `ok` | `N/A` | `no` | `none` | 4.8729 |
| `case_061` | `ok` | `N/A` | `no` | `none` | 4.3554 |
| `case_101` | `ok` | `N/A` | `no` | `none` | 5.4414 |
| `case_165` | `ok` | `N/A` | `no` | `none` | 4.4180 |
| `case_243` | `ok` | `N/A` | `no` | `none` | 4.9923 |
| `case_261` | `ok` | `N/A` | `no` | `none` | 5.2387 |
| `case_323` | `ok` | `N/A` | `no` | `none` | 7.9343 |
| `case_329` | `ok` | `N/A` | `no` | `none` | 5.2828 |
| `case_397` | `ok` | `N/A` | `no` | `none` | 3.9751 |