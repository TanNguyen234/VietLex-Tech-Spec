# VIETLEX EVALUATION REPORT — answer-representative10-v5-minimal-guardrail-fixed-live-20260822

**Run ID**: `answer-representative10-v5-minimal-guardrail-fixed-live-20260822`  
**Profile**: `separated_intent`  
**UTC Timestamp**: `2026-08-22T13:53:51.088763+00:00`  
**Git Commit SHA**: `75f9f19cde535f1994c521c9c0576e576764b781`  
**Source State SHA-256**: `09fe23a5b3c02db056796a642687b9e45be42700c0bd9e7695f9b6f9477aa3d5`  
**Git Dirty Status**: `True` (Diff: `ok`, SHA-256: `e92df9c3d9e75c1075d3275d8f21478364ffede54fc31b3de2a687777a43f6be`)  
...
**Execution Command**: `run_answer_eval.py --case-ids case_017 case_036 case_061 case_101 case_165 case_243 case_261 case_323 case_329 case_397 --verified-only --gold-policy all-required-verified --profile separated_intent --rewrite off --guardrails enforce --reranker current --concurrency 1 --judge ragas --run-id answer-representative10-v5-minimal-guardrail-fixed-live-20260822`  
...
| :--- | ---: | ---: | ---: |
| `t_input_guardrail` | 1.0419 | 1.4407 | 1.1012 |
| `t_output_guardrail` | 1.1856 | 1.2769 | 1.1709 |
| `t_retrieval` | 2.6331 | 3.8356 | 2.7773 |
| `t_rewrite` | 0.0000 | 0.0000 | 0.0000 |
| `t_total` | 8.4390 | 9.1524 | 8.3829 |
